...
export const LITURGICAL_THEMES = {
  ...
  CHRISTMAS: {
    ...
    color: "#FFFFFF", // White
    description:
      "Celebration of Christ's birth and God becoming human. Songs should express joy and wonder at the incarnation.",
  },
  EPIPHANY: {
    name: "Epiphany",
    color: "#118AB2", // Blue
    description:
      "Christ revealed to all nations. Songs should focus on Jesus as light of the world and our response to his revelation.",
  },
  LENT: {
    name: "Lent",
  ...
  HOLY_WEEK: {
    ...
    color: "#000000", // Black
    description:
      "The final week before Easter. Songs should follow Jesus' journey from triumphant entry to crucifixion.",
  },
  EASTER: {
    name: "Easter",
    color: "#FFD700", // Gold
    description:
      "A 50-day celebration of Christ's resurrection. Songs should express joy, victory, and the power of new life.",
  },
  PENTECOST: {
    name: "Pentecost",
    color: "#FF4500", // Red
    description:
      "Celebrating the Holy Spirit's coming. Songs should focus on the Spirit's power, gifts, and the church's mission.",
  },
  ORDINARY_TIME: {
    name: "Ordinary Time",
    color: "#228B22", // Green
    description:
      "The growing season between major festivals. Songs should focus on discipleship, everyday faith, and living out God's word.",
  },
  UNKNOWN: {
    name: "Unknown Season",
    color: "#808080", // Gray
...
export function getSeasonThemes(seasonId) {
  switch (seasonId) {
    case "ADVENT":
      return {
        primaryThemes: ["Waiting with hope for Christ's coming"],
        secondaryThemes: [
          "Hope in darkness",
    ...
    case "CHRISTMAS":
      return {
        primaryThemes: ["Jesus born as God-with-us"],
        secondaryThemes: [
    ...
    case "EPIPHANY":
      return {
        primaryThemes: ["Christ revealed to all nations"],
        secondaryThemes: [
    ...
    case "LENT":
      return {
        primaryThemes: ["Repentance and spiritual renewal"],
        secondaryThemes: [
    ...
    case "HOLY_WEEK":
      return {
        primaryThemes: ["Jesus' sacrificial love and path to the cross"],
        secondaryThemes: [
    ...
    case "EASTER":
      return {
        primaryThemes: ["Christ's victory over death and sin"],
        secondaryThemes: [
    ...
    case "PENTECOST":
      return {
        primaryThemes: ["The Holy Spirit empowering believers"],
        secondaryThemes: [
    ...
    case "ORDINARY_TIME":
      return {
        primaryThemes: ["Growing as disciples in everyday life"],
        secondaryThemes: [
  ...
  switch (seasonId) {
    case "ADVENT":
      return {
        ...
        caution:
          "Save Christmas songs for the Christmas season - focus on anticipation now",
      };
    ...
    case "CHRISTMAS":
      return {
        ...
        caution:
          "Look beyond just the manger scene to the meaning of incarnation",
      };
    ...
    case "EPIPHANY":
      return {
        ...
        caution:
          "This season has its own character - it's not just extended Christmas",
      };
    ...
    case "LENT":
      return {
        ...
        caution:
          "Include lyrics about God's grace - Lent isn't about feeling bad",
      };
    ...
    case "EASTER":
      return {
        ...
        caution:
          "Emphasize that Easter is about today, not just a historical event",
      };
    ...
    case "ORDINARY_TIME":
      return {
        ...
        caution:
          "Vary your selections during this long season to prevent monotony",
      };
