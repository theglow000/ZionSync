...
const AVTeam = ({ selectedYear, setSelectedYear, availableYears }) => {
  ...
  const handleError = useMemo(
    () =>
      createErrorHandler("A/V Team", (message) =>
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (assignmentsData.assignments) {
          setAssignments(
            assignmentsData.assignments.reduce((acc, curr) => {
              acc[curr.date] = {
  ...
  return (
    ...
    >
                          ...
                          {dates.map((item, index) => (
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <span className="flex-1 text-center pr-2">
                                    {assignments[item.date]?.team_member_1 ||
                                      "Ben"}
                                  </span>
                                  <button
                                    onClick={(e) => {
                              ...
                              >
                                ...
                                >
                                  <span className="flex-1 text-center pr-2">
                                    {assignments[item.date]?.team_member_2 ||
                              ...
                              <td style={{ width: "16%" }} className="p-2">
                                {assignments[item.date]?.team_member_3 ? (
                                  ...
                                  >
                                    ...
                                    <button
                                      onClick={() =>
                                        handleRemoveAssignment(item.date)
                                      }
                                      className="text-red-500 hover:text-red-700 flex-shrink-0"
                                    >
      ...
      <UserSelectionModal
        ...
        currentAssignments={
          editingPosition?.date ? assignments[editingPosition.date] || {} : {}
        }
