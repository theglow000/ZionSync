...
const SongDatabase = () => {
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      const usageResponse = await fetchWithTimeout(
        `/api/song-usage?title=${encodeURIComponent(selectedSong.title)}`,
      );
      ...
      if (usageResponse.ok) {
        ...
        if (usageData && usageData.length > 0) {
          ...
          const confirmed = await confirm({
            ...
            details: [
              "Historical data will be preserved but marked as deleted",
            ],
            variant: "danger",
  ...
  const handleDeleteSong = async () => {
    try {
      ...
      if (result.hadUsageHistory) {
        showAlertMessage(
          "Song deleted. Historical usage records have been preserved.",
        );
      } else {
  ...
  const addSongToService = async () => {
    ...
    try {
      ...
      // Success handling
      showAlertMessage(
        `Added "${selectedSong.title}" to service on ${selectedService.date}`,
      );
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {showAlert && (
        <Alert
          className={`fixed top-4 right-4 z-50 w-80 bg-white border-${alertType === "success" ? "green" : "red"}-500 shadow-lg`}
        >
          <div className="flex items-center gap-2 p-2">
            <AlertCircle
              className={`w-5 h-5 text-${alertType === "success" ? "green" : "red"}-500`}
            />
              ...
              <div className="md:col-span-1 border rounded-lg overflow-hidden bg-white">
                <div className="bg-gray-50 p-3 border-b">
                  <h3 className="font-medium text-gray-700">
                    Song List ({filteredSongs.length})
                  </h3>
                </div>
                      ...
                      {filteredSongs.map((song) => (
                        ...
                        >
                          ...
                          <div className="flex items-center text-xs text-gray-500 mt-1">
                            <span
                              className={`px-1.5 py-0.5 rounded ${song.type === "hymn" ? "bg-blue-100 text-blue-700" : "bg-green-100 text-green-700"}`}
                            >
                      ...
                      <div className="p-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                handleEditorInputChange("title", e.target.value)
                              }
                            />
                          </div>
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                handleEditorInputChange("type", e.target.value)
                              }
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                            {liturgicalSeasons.map((season) => (
                              <button
                                key={season.id}
                                onClick={() =>
                                  handleSeasonalTagToggle(season.id)
                                }
                              ...
                              >
                                ...
                                {editingSong.seasonalTags?.includes(
                                  season.id,
                                ) && (
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              handleEditorInputChange("notes", e.target.value)
                            }
                    ...
                    <div>
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center mb-4">
                          <span
                            className={`px-2 py-0.5 rounded text-xs ${selectedSong.type === "hymn" ? "bg-blue-100 text-blue-700" : "bg-green-100 text-green-700"}`}
                          >
                            {selectedSong.type === "hymn"
                              ? "Hymn"
                              : "Contemporary"}
                          ...
                          {selectedSong.type === "hymn" ? (
                            <>
                              <div>
                                ...
                                <p className="text-black">
                                  {selectedSong.number || "Not specified"}
                                </p>
                              </div>
                              <div>
                                <label className="block text-xs font-medium text-gray-500">
                                ...
                                <p className="text-black">
                                  {selectedSong.hymnal
                                    ? hymnalVersions.find(
                                        (v) => v.id === selectedSong.hymnal,
                                      )?.name || selectedSong.hymnal
                                    : "Not specified"}
                                </p>
                              </div>
                              {selectedSong.hymnaryLink && (
                            ...
                            <>
                              <div className="md:col-span-2">
                                ...
                                <p className="text-black">
                                  {selectedSong.author || "Not specified"}
                                </p>
                              </div>
                              {selectedSong.songSelectLink && (
                                <div className="md:col-span-2">
                        ...
                        {selectedSong && !showSongEditor && (
                          <div className="mt-4">
                            ...
                            {selectedSong.seasonalTags &&
                            selectedSong.seasonalTags.length > 0 ? (
                        ...
                        {selectedSong && !showSongEditor && (
                          <div className="mt-4">
                            ...
                            <div className="flex flex-wrap gap-2 mt-1">
                              {getRotationStatusDisplay(selectedSong)?.map(
                                (status, index) => (
                                  <div
                                    key={index}
                              ...
                              {(!selectedSong.rotationStatus ||
                                getRotationStatusDisplay(selectedSong)
                                  ?.length === 0) && (
          ...
          {showMergeModal && selectedSong && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white p-6 rounded-lg w-full max-w-md">
                ...
                <p className="mb-4">
                  Merge "{selectedSong.title}" into another song. This will move
                  all usage history to the target song and delete this song.
                </p>
                ...
                <div className="p-4">
                  ...
                  {loadingServices ? (
                    <div className="text-center py-4 text-gray-500">
                      <LoadingSpinner
                        size="md"
                        className="border-purple-700 mx-auto mb-1"
                      />
                    ...
                    <div className="space-y-3">
                      {upcomingServices.map((service) => {
                        ...
                        const isExpanded =
                          selectedService?.date === service.date;
                              ...
                              <div className="flex items-center gap-2">
                                {service.liturgical && (
                                  <div
                                    ...
                                    style={{
                                      backgroundColor:
                                        service.liturgical.color || "#6B7280",
                                    }}
                                ...
                                <div>
                                  <div className="font-medium">
                                    {service.title ||
                                      `${service.liturgical?.seasonName || "Sunday"} Service`}
                                  </div>
                                      ...
                                      {selectedPosition === position.id &&
                                        position.hasSelection && (
                                          <div className="px-2 py-1 bg-amber-50 border-t border-amber-100 text-xs text-amber-600 flex items-center gap-1">
                                            <div>⚠️</div>
                                            <div>
                                              This will replace the current song
                                            </div>
                                          </div>
                                        )}
                                    </div>
                  ...
                  <div className="flex justify-end gap-2 mt-6">
                    ...
                    <button
                      ...
                      disabled={
                        !selectedService || !selectedPosition || isAddingSong
                      }
