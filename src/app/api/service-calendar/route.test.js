...
describe('Service Calendar API - GET', () => {
  ...
  test('returns services for valid year', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/service-calendar?year=2025');
  ...
  test('returns 400 for missing year parameter', async () => {
    const request = new NextRequest('http://localhost:3000/api/service-calendar');
    const response = await GET(request);
    const data = await response.json();
  ...
  test('returns 400 for year below range', async () => {
    const request = new NextRequest('http://localhost:3000/api/service-calendar?year=2023');
    const response = await GET(request);
    const data = await response.json();
  ...
  test('returns 400 for year above range', async () => {
    const request = new NextRequest('http://localhost:3000/api/service-calendar?year=2101');
    const response = await GET(request);
    const data = await response.json();
  ...
  test('returns 404 for year not generated', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/service-calendar?year=2026');
    const response = await GET(request);
    const data = await response.json();
