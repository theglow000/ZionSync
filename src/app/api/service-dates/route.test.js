...
describe("Service Dates Bridge API", () => {
  ...
  describe("GET /api/service-dates", () => {
    test("returns services for valid year", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/service-dates?year=2025",
      );
    ...
    test("filters for upcoming services only when upcomingOnly=true", async () => {
      ...
      const request = new NextRequest(
        `http://localhost:3000/api/service-dates?year=${today.getFullYear()}&upcomingOnly=true`,
      );
      const response = await GET(request);
      const data = await response.json();
      ...
      expect(
        data.every(
          (service) =>
            service.title === "Future Service" ||
            service.title !== "Past Service",
        ),
      ).toBe(true);
    });
    ...
    test("returns 400 for missing year parameter", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/service-dates",
      );
      const response = await GET(request);
      const data = await response.json();
    ...
    test("returns 400 for year out of range", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/service-dates?year=2023",
      );
      const response = await GET(request);
      const data = await response.json();
    ...
    test("returns 400 for year above maximum", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/service-dates?year=2101",
      );
      const response = await GET(request);
      const data = await response.json();
    ...
    test("returns 404 when year not generated yet", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/service-dates?year=2030",
      );
      const response = await GET(request);
      const data = await response.json();
    ...
    test("returns all services when upcomingOnly=false", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/service-dates?year=2025&upcomingOnly=false",
      );
      const response = await GET(request);
      const data = await response.json();
    ...
    test("handles multi-year calendars correctly", async () => {
      ...
      const request2026 = new NextRequest(
        "http://localhost:3000/api/service-dates?year=2026",
      );
  ...
  describe("Error handling", () => {
    ...
    test("handles malformed year parameter", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/service-dates?year=abc",
      );
      const response = await GET(request);
      const data = await response.json();
